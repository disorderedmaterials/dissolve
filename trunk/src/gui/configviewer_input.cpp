/*
	...
	*** src/gui/configviewer_input.cpp
...
void ConfigViewer::mouseReleaseEvent(QMouseEvent* event)
{
...
void ConfigViewer::mouseMoveEvent(QMouseEvent* event)
{
	Vec3<double> delta;
	Matrix4 A;
...
void ConfigViewer::wheelEvent(QWheelEvent* event)
{
