...
If, for some reason, the LigParGen service is offline we provide some test data here, and which is also included in the example data on the [GitHub releases page](https://github.com/disorderedmaterials/dissolve/releases).
