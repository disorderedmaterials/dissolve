...
|:------|:--:|:-----:|-----------|
|`Angle`|`i`<br/>`j`<br/>`k`<br/>`form`<br/>[`parameters`]|--|Create an intramolecular angle definition between the three atom indices `i`-`j`-`k`, and with the named [functional `form`]({{< ref "ffangle" >}}) and `parameters`. The [functional form]({{< ref "ffangle" >}}) may instead be replaced with the name of an existing [master term]({{< ref "masterblock" >}}) preceded with an ampersand (`@`), in which case the master term form and parameters will be used for this interaction.|
...
|`Bond`|`i`<br/>`j`<br/>`form`<br/>[`parameters`]|--|Create an intramolecular bond definition between the two atom indices `i`-`j`, and with the named [functional `form`]({{< ref "ffbond" >}}) and `parameters`. The [functional form]({{< ref "ffbond" >}}) may instead be replaced with the name of an existing [master term]({{< ref "masterblock" >}}) preceded with an ampersand (`@`), in which case the master term form and parameters will be used for this interaction.|
...
|`CoordinateSets`|[`ConfigurationFileAndFormat`]({{< ref "configurationformat" >}})|--|Sets a file from which coordinates for the species are read in, and which are used when adding multiple copies of the species to a [configuration]({{< ref "configurationblock" >}}) in its generator definition.|
...
|`Improper`|`i`<br/>`j`<br/>`k`<br/>`l`<br/>`form`<br/>[`parameters`]|--|Create an intramolecular improper torsion definition between the four atom indices `i`-`j`-`k`-`l` (where `i` is the central atom), and with the named [functional `form`]({{< ref "ffimproper" >}}) and `parameters`. The [functional form]({{< ref "ffimproper" >}}) may instead be replaced with the name of an existing [master term]({{< ref "masterblock" >}}) preceded with an ampersand (`@`), in which case the master term form and parameters will be used for this interaction.|
...
|`Torsion`|`i`<br/>`j`<br/>`k`<br/>`l`<br/>`form`<br/>[`parameters`]|--|Create an intramolecular torsion (dihedral angle) definition between the four atom indices `i`-`j`-`k`-`l`, and with the named [functional `form`]({{< ref "fftorsion" >}}) and `parameters`. The [functional form]({{< ref "fftorsion" >}}) may instead be replaced with the name of an existing [master term]({{< ref "masterblock" >}}) preceded with an ampersand (`@`), in which case the master term form and parameters will be used for this interaction.|
