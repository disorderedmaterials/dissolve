...
Warning: Using CMake v4 to build Dissolve with Visual Studio may lead to build errors due to deprecation of CMake v3.x which is currently used.
If the system CMake Visual Studio is using is v4, you can obtain an older version of CMake and point Visual Studio to it using the
`cmakeExectuable` property in the `CMakeSettings.json`
