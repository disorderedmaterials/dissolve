...
The [`RDF`]({{< ref "rdf" >}}) module dictates the target configurations from which the $g(r)$, and hence the $S(Q)$, are generated - as such, the `SQ` module does not target any configurations itself. If Bragg scattering is to be explicitly included, a source [`Bragg`]({{< ref "bragg" >}}) module can be specified with the [`IncludeBragg`](#control-keywords) keyword.
