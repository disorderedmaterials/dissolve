...
TEST(NeutronWeightsTest, Simple)
{
    ...
    EXPECT_EQ(20, nwts.atomTypes().population(molecules.atN().get()));
...
TEST(NeutronWeightsTest, Water)
{
    ...
    nwts.createFromIsotopologues({});
    EXPECT_EQ(1, nwts.atomTypes().population(molecules.atOW().get()));
    EXPECT_EQ(2, nwts.atomTypes().population(molecules.atHW().get()));
...
TEST(NeutronWeightsTest, NullWater)
{
    ...
    nwts.createFromIsotopologues({});
    EXPECT_EQ(1000, nwts.atomTypes().population(molecules.atOW().get()));
    EXPECT_EQ(2000, nwts.atomTypes().population(molecules.atHW().get()));
    EXPECT_NEAR(1.0 / 3.0, nwts.atomTypes().fraction(molecules.atOW().get()), 1.0e-6);
    EXPECT_NEAR(2.0 / 3.0, nwts.atomTypes().fraction(molecules.atHW().get()), 1.0e-6);
...
TEST(NeutronWeightsTest, Mix)
{
    ...
    EXPECT_EQ(1, nwts.atomTypes().population(molecules.atOW().get()));
    EXPECT_EQ(2, nwts.atomTypes().population(molecules.atHW().get()));
    EXPECT_EQ(2, nwts.atomTypes().population(molecules.atN().get()));
