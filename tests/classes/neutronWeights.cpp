...
TEST(NeutronWeightsTest, Simple)
{
    ...
    EXPECT_EQ(20, nwts.atomTypes().atomTypeData(molecules.atN().get())->get().population());
    EXPECT_NEAR(1.0, nwts.atomTypes().atomTypeData(molecules.atN().get())->get().fraction(), 1.0e-6);
...
TEST(NeutronWeightsTest, Water)
{
    ...
    nwts.createFromIsotopologues({});
    EXPECT_EQ(1, nwts.atomTypes().atomTypeData(molecules.atOW().get())->get().population());
    EXPECT_EQ(2, nwts.atomTypes().atomTypeData(molecules.atHW().get())->get().population());
    EXPECT_NEAR(1.0 / 3.0, nwts.atomTypes().atomTypeData(molecules.atOW().get())->get().fraction(), 1.0e-6);
    EXPECT_NEAR(2.0 / 3.0, nwts.atomTypes().atomTypeData(molecules.atHW().get())->get().fraction(), 1.0e-6);
    EXPECT_NEAR(
...
TEST(NeutronWeightsTest, NullWater)
{
    ...
    nwts.createFromIsotopologues({});
    EXPECT_EQ(1000, nwts.atomTypes().atomTypeData(molecules.atOW().get())->get().population());
    EXPECT_EQ(2000, nwts.atomTypes().atomTypeData(molecules.atHW().get())->get().population());
    EXPECT_NEAR(1.0 / 3.0, nwts.atomTypes().atomTypeData(molecules.atOW().get())->get().fraction(), 1.0e-6);
    EXPECT_NEAR(2.0 / 3.0, nwts.atomTypes().atomTypeData(molecules.atHW().get())->get().fraction(), 1.0e-6);
...
TEST(NeutronWeightsTest, Mix)
{
    ...
    EXPECT_EQ(1, nwts.atomTypes().atomTypeData(molecules.atOW().get())->get().population());
    EXPECT_EQ(2, nwts.atomTypes().atomTypeData(molecules.atHW().get())->get().population());
    EXPECT_EQ(2, nwts.atomTypes().atomTypeData(molecules.atN().get())->get().population());
    EXPECT_NEAR(1.0 / 5.0, nwts.atomTypes().atomTypeData(molecules.atOW().get())->get().fraction(), 1.0e-6);
    EXPECT_NEAR(2.0 / 5.0, nwts.atomTypes().atomTypeData(molecules.atHW().get())->get().fraction(), 1.0e-6);
    EXPECT_NEAR(2.0 / 5.0, nwts.atomTypes().atomTypeData(molecules.atN().get())->get().fraction(), 1.0e-6);
