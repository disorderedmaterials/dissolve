...
//     oAt->interactionPotential().setFormAndParameters(ShortRangeFunctions::Form::LennardJones, "epsilon=0.6503
//     sigma=3.165492"); oAt->setCharge(-0.82); o->addAtom(Elements::Element::O, {}, -0.82, oAt);
//
...
//         // C-C bond: (i, i+2)
//         species->addBond(i, (i + 2) % 12).setInteractionFormAndParameters(BondFunctions::Form::Harmonic, "k=3924.592
//         eq=1.4");
