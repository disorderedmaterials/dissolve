...
{
    ASSERT_NO_THROW(systemTest.setUp("dissolve/siteRDF-water.txt"));
...
{
    ASSERT_NO_THROW(systemTest.setUp("dissolve/siteRDF-waterNPT.txt"));
    ASSERT_TRUE(systemTest.dissolve().iterate(95));
...
{
    ASSERT_NO_THROW(systemTest.setUp("dissolve/siteRDF-waterDynamic.txt"));
    ASSERT_TRUE(systemTest.dissolve().iterate(95));
...
{
    ASSERT_NO_THROW(systemTest.setUp("dissolve/siteRDF-waterFragments.txt"));
    ASSERT_TRUE(systemTest.dissolve().iterate(95));
