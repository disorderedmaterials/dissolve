...
TEST_F(VoxelDensityModuleTest, Mass)
{
    ...
    */
    ...
    VoxelDensityModule* modules[] = {
        systemTest.getModule<VoxelDensityModule>("VoxelDensity(1-bin)"),
    ...
    /*
    auto *module1 = systemTest.getModule<VoxelDensityModule>("VoxelDensity(1-bin)");
    auto *module2 = systemTest.getModule<VoxelDensityModule>("VoxelDensity(2-bin)");
    auto *module4 = systemTest.getModule<VoxelDensityModule>("VoxelDensity(4-bin)");
    auto *module8 = systemTest.getModule<VoxelDensityModule>("VoxelDensity(8-bin)");
    auto *module16 = systemTest.getModule<VoxelDensityModule>("VoxelDensity(16-bin)");
    */
    // Iterate
    ...
    for (int n = 0; n <= 4; n++)
    {
        ...
        const auto &data = systemTest.dissolve().processingModuleData().search<const Data1D>(fmt::format("VoxelDensity({}-bin)//Data1D", nAxisVoxels))->get();
    ...
    */
    ...
    // Check data
    const auto &data16 = systemTest.dissolve().processingModuleData().search<const Data1D>("VoxelDensity(16-bin)//Data1D")->get();
