...
TEST_F(SpeciesTabTest, Atoms)
{
    ...
    ASSERT_TRUE(dissolve.loadInput("dissolve/benzene.txt"));
...
TEST_F(SpeciesTabTest, Impropers)
{
    ...
    ASSERT_TRUE(dissolve.loadInput("dissolve/py5-ntf2.txt"));
    auto &species = coreData.species()[0];
...
TEST_F(SpeciesTabTest, Isotopologues)
{
    ...
    ASSERT_TRUE(dissolve.loadInput("dissolve/water.txt"));
    auto &species = coreData.species()[0];
