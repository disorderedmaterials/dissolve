...
TEST(PCL2019AnionsAssignmentTest, beti)
{
    ...
    checkSpeciesAtomType(&species, {{0, "C1F"}, {1, "CEF"}, {2, "F1"},  {3, "F1"},   {4, "SBT"},  {5, "NBT"},  {6, "OBT"},
...
TEST(PCL2019AnionsAssignmentTest, BF4)
{
    ...
    checkSpeciesAtomType(&species, {{0, "B"}, {1, "FB"}, {2, "FB"}, {3, "FB"}, {4, "FB"}});
    EXPECT_NEAR(species.totalCharge(true), -1, 1.0e-6);
}
...
TEST(PCL2019AnionsAssignmentTest, c2SO3)
{
    ...
    checkSpeciesAtomType(&species, {{0, "SO"},
                                    {1, "OS3"},
                                    {2, "OS3"},
                                    {3, "OS3"},
                                    {4, "CS3"},
...
TEST(PCL2019AnionsAssignmentTest, CCN3)
{
    ...
    checkSpeciesAtomType(&species, {{0, "C3A"}, {1, "CN"}, {2, "CN"}, {3, "CN"}, {4, "NC"}});
    EXPECT_NEAR(species.totalCharge(true), -1, 1.0e-6);
}
...
TEST(PCL2019AnionsAssignmentTest, dca)
{
    ...
    checkSpeciesAtomType(&species, {{0, "N3A"}, {1, "CZA"}, {2, "NZA"}, {3, "CZA"}, {4, "NZA"}});
    EXPECT_NEAR(species.totalCharge(true), -1, 1.0e-6);
}
...
TEST(PCL2019AnionsAssignmentTest, ntf2)
{
    ...
    checkSpeciesAtomType(&species, {{0, "CBT"},
                                    {1, "F1"},
                                    {2, "F1"},
                                    {3, "F1"},
                                    {4, "SBT"},
...
TEST(PCL2019AnionsAssignmentTest, oac)
{
    ...
    checkSpeciesAtomType(&species, {{0, "CTA"}, {1, "HC"}, {2, "HC"}, {3, "HC"}, {4, "CO2"}, {5, "O2"}, {6, "O2"}});
    EXPECT_NEAR(species.totalCharge(true), -1, 1.0e-6);
}
...
TEST(PCL2019AnionsAssignmentTest, PF6)
{
    ...
    checkSpeciesAtomType(&species, {{0, "P"}, {1, "FP"}, {2, "FP"}, {3, "FP"}, {4, "FP"}, {5, "FP"}, {6, "FP"}});
    EXPECT_NEAR(species.totalCharge(true), -1, 1.0e-6);
}
...
TEST(PCL2019AnionsAssignmentTest, SCN)
{
    ...
    checkSpeciesAtomType(&species, {{0, "SK"}, {1, "CK"}, {2, "NK"}});
    EXPECT_NEAR(species.totalCharge(true), -1, 1.0e-6);
}
...
TEST(PCL2019AnionsAssignmentTest, tfa)
{
    ...
    checkSpeciesAtomType(&species, {{0, "CFA"}, {1, "FFA"}, {2, "FFA"}, {3, "FFA"}, {4, "CO2"}, {5, "O2F"}, {6, "O2F"}});
    EXPECT_NEAR(species.totalCharge(true), -1, 1.0e-6);
}
...
TEST(PCL2019AnionsAssignmentTest, tso)
{
    ...
    checkSpeciesAtomType(&species, {{0, "CATS"},
                                    {1, "CAOS"},
                                    {2, "CAMS"},
                                    {3, "CAOS"},
                                    {4, "CAMS"},
