...
TEST(UFFNMethylFormamideForcefieldTest, NMethylFormamide)
{
    ...
    systemTest.checkSpeciesAtomType(&species, 0, "H_");
    systemTest.checkSpeciesAtomType(&species, 1, "C_amR");
    systemTest.checkSpeciesAtomType(&species, 2, "N_amR");
    systemTest.checkSpeciesAtomType(&species, 3, "O_2");
    systemTest.checkSpeciesAtomType(&species, 4, "C_3");
    systemTest.checkSpeciesAtomType(&species, 5, "H_");
    systemTest.checkSpeciesAtomType(&species, 6, "H_");
    systemTest.checkSpeciesAtomType(&species, 7, "H_");
    systemTest.checkSpeciesAtomType(&species, 8, "H_");
