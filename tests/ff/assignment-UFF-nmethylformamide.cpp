...
TEST(UFFNMethylFormamideAssignmentTest, NMethylFormamide)
{
    ...
    testSpeciesIntramolecular(&species, {1, 2, 4}, {AngleFunctions::Form::Cos2, "882.7151 0.5 0.666667 0.333333"}, 5.0e-5);
    testSpeciesIntramolecular(&species, {3, 1, 2}, {AngleFunctions::Form::Cos2, "1590.3058 0.5 0.6667 0.3333"}, 5.0e-5);
    testSpeciesIntramolecular(&species, {8, 4, 7}, {AngleFunctions::Form::Cos2, "315.8868 0.343737 0.37492 0.281246"}, 6.0e-5);
    testSpeciesIntramolecular(&species, {0, 1, 2, 4}, {TorsionFunctions::Form::UFFCosine, "101.9308  2  180"}, 2.0e-5);
    testSpeciesIntramolecular(&species, {1, 0, 2, 3}, {TorsionFunctions::Form::FourierN, "209.2 1 -1 0"});
    testSpeciesIntramolecular(&species, {2, 5, 1, 4}, {TorsionFunctions::Form::FourierN, "25.104 1 -1 0"});
}
}; // namespace UnitTest
