...
; Conan Dependencies
Source: "{#DeployDir}\tbb12.dll"; DestDir: "{app}\bin"
Source: "{#DeployDir}\tbbmalloc.dll"; DestDir: "{app}\bin"
Source: "{#DeployDir}\tbbmalloc_proxy.dll"; DestDir: "{app}\bin"
Source: "{#DeployDir}\tbbbind_2_5.dll"; DestDir: "{app}\bin"
Source: "{#DeployDir}\antlr4-runtime.dll"; DestDir: "{app}\bin"
