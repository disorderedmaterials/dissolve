{ lib, stdenv, fetchFromGitHub, fetchpatch, cmake, tbb }:

stdenv.mkDerivation rec {
  pname = "oneDPL";
  version = "oneDPL-2022.0.0-release ";
  ...
  src = fetchFromGitHub {
    owner = "oneapi-src";
    repo = "oneDPL";
    rev = "240685db73e3169e66dbb625b4d5fa1ad06ec79b";
    sha256 = "5E/EUJjhi6VQfYo3qdDHiETnXNEymsLR3hMSH5Gfa0M=";
  };
