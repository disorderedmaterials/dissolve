...
NeutronSQNode::NeutronSQNode(Graph *parentGraph) : Node(parentGraph)
{
    ...
    addOptionalPointerOutput<PartialSet>("WeightedSQ", "Weighted partial structure factors for target configuration", weightedSQ_);
    addOptionalPointerOutput<PartialSet>("WeightedGR", "Weighted partial radial distribution functions for target configuration", weightedGR_);
