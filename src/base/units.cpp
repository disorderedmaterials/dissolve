...
{
	static EnumOptionsList DensityUnitsSchemeOptions = EnumOptionsList() << EnumOption(Units::AtomsPerAngstromUnits, "atoms/A3") << EnumOption(Units::GramsPerCentimetreCubedUnits, "g/cm3");
