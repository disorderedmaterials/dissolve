...
#ifndef DISSOLVE_NODEVALUE_H
#define DISSOLVE_NODEVALUE_H
...
class NodeValue
{
	...
	private:
	// Value Types
	enum NodeValueType { IntegerNodeValue, DoubleNodeValue, ExpressionNodeValue };
	...
	const char* asString(bool addQuotesIfRequired = false);
};
