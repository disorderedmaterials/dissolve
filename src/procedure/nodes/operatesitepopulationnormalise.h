/*
	...
	*** src/procedure/nodes/operatesitepopulationnormalise.h
...
#ifndef DISSOLVE_PROCEDURENODE_OPERATESITEPOPULATIONNORMALISE_H
#define DISSOLVE_PROCEDURENODE_OPERATESITEPOPULATIONNORMALISE_H
...
class OperateSitePopulationNormaliseProcedureNode : public OperateProcedureNodeBase
{
	...
	OperateSitePopulationNormaliseProcedureNode(RefList<SelectProcedureNode> selectNodes);
	// Destructor
	~OperateSitePopulationNormaliseProcedureNode();
