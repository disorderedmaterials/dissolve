...
double ExternalPotential::energy(const ConfigurationAtom &i, const Box &box) const { return 0.0; }

// Calculate force on specified atom, summing in to supplied vector
void ExternalPotential::force(const ConfigurationAtom &i, const Box &box, Vector3 &f) const {}
