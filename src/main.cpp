...
#ifdef PARALLEL
    Messenger::print("Dissolve PARALLEL version {}, Copyright (C) 2022 Team Dissolve and contributors.\n", Version::info());
#else
    Messenger::print("Dissolve SERIAL version {}, Copyright (C) 2022 Team Dissolve and contributors.\n", Version::info());
#endif
