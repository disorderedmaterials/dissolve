		...
		if (argv[n][0] == '-')
		{
			...
			switch (argv[n][1])
			{
				case ('h'):
					...
					printf("\t-x\t\tDon't write any restart information and heartbeat file(but still read in the restart file if present)\n");
				...
				case ('x'):
					...
					Messenger::print("No restart file or heartbeat files will be written.\n");
					break;
				default:
