/*
	...
	*** src/modules/keywordtypes/analyser.h
...
#ifndef DISSOLVE_MODULEKEYWORD_ANALYSER_H
#define DISSOLVE_MODULEKEYWORD_ANALYSER_H
...
class AnalyserModuleKeyword : public ModuleKeywordBase, public ModuleKeywordData<Analyser&>
{
	public:
	// Constructor
	AnalyserModuleKeyword(Analyser& analyser);
	// Destructor
	~AnalyserModuleKeyword();
