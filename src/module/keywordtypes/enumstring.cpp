...
EnumStringModuleKeyword::EnumStringModuleKeyword(EnumOptionsBase options) : ModuleKeywordBase(ModuleKeywordBase::EnumStringData), ModuleKeywordData<CharString>(options.optionKeyword())
{
	// Set our array of valid values
