...
const char* KeywordDataTypeKeywords[] = { "Complex", "Bool", "Integer", "Double", "CharString", "AtomTypeSelection", "BroadeningFunction", "IsotopologueList", "PairBroadeningFunction", "WindowFunction", "XYDataStore" };
