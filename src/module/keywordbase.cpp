...
const char* KeywordDataTypeKeywords[] = { "Complex", "Bool", "Integer", "Double", "CharString", "Analyser", "AtomTypeSelection", "BroadeningFunction", "IsotopologueList", "PairBroadeningFunction", "WindowFunction", "XYDataStore" };
