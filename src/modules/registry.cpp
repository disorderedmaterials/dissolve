...
ModuleRegistry::ModuleRegistry()
{
    ...
    registerProducer<VoxelDensityModule>(ModuleTypes::VoxelDensity, "Describe distribution of atomic number, mass, and scattering length density across unit cell voxels", "Analysis");
