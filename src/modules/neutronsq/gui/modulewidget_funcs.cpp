...
// Constructor
NeutronSQModuleWidget::NeutronSQModuleWidget(QWidget* parent, Module* module, DUQ& dUQ) : ModuleWidget(parent), module_(module), dUQ_(dUQ)
{
...
void NeutronSQModuleWidget::addPartialSetToTree(PartialSet& partials, QTreeWidgetItem* topLevelItem, NeutronSQModuleWidget::DataType rootType, const char* rootTitle, int addAverageContributions)
{
...
// 			MimeTreeWidgetItem* fullItem = new MimeTreeWidgetItem(setItem, rootType+NeutronSQModuleWidget::FullData);
...
// 			// -- Bound partial
// 			MimeTreeWidgetItem* subItem = new MimeTreeWidgetItem(fullItem, rootType+NeutronSQModuleWidget::BoundData);
...
// 
// 			// -- Unbound partial
// 			subItem = new MimeTreeWidgetItem(fullItem, rootType+NeutronSQModuleWidget::UnboundData);
...
// 
// 			// -- Bragg partial
// 			subItem = new MimeTreeWidgetItem(fullItem, rootType+NeutronSQModuleWidget::BraggData);
...
// 				block += " EndCollection";
// 				subItem = new MimeTreeWidgetItem(fullItem, rootType+NeutronSQModuleWidget::FullData);
...
void NeutronSQModuleWidget::repopulateSourceTree()
{
// 	// Clear the tree
...
// 
// 			addPartialSetToTree(unweightedgr, cfgItem, NeutronSQModuleWidget::UnweightedGRData, "Unweighted g(r)", maxSetsInAverage);
// 		}
// 
...
// 
// 			addPartialSetToTree(unweightedsq, cfgItem, NeutronSQModuleWidget::UnweightedSQData, "Unweighted S(Q)");
// 		}
// 	}
}

void NeutronSQModuleWidget::on_SourcesTree_itemDoubleClicked(QTreeWidgetItem* item, int column)
{
	if (item == NULL) return;
	...
	switch (item->type())
	{
		case (NeutronSQModuleWidget::FullData):
			break;
	}
}
