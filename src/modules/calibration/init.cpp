...
void CalibrationModule::initialise()
{
	...
	// RDF Calibration
	keywords_.add("RDF Calibration", new ModuleRefListKeyword(intraBroadeningModules_, "RDF"), "AdjustIntraBroadening",
		      "Add specified RDF module as a target for IntraBroadening adjustment", "<RDFModule>");

	// NeutronSQ Calibration
	keywords_.add("NeutronSQ Calibration", new ModuleRefListKeyword(intraBroadeningNeutronGRReferences_, "NeutronSQ"),
		      ...
		      "<NeutronSQModule>");
	keywords_.add("NeutronSQ Calibration", new ModuleRefListKeyword(intraBroadeningNeutronSQReferences_, "NeutronSQ"),
