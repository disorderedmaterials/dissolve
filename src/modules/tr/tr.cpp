...
TRModule::TRModule() : Module(ModuleTypes::TR)
{
    ...
    keywords_.add<BoolKeyword>(
        ...
        internalTest_);
    keywords_.add<EnumOptionsKeyword<TRModule::PartialsMethod>>(
        "Method", "Calculation method for partial radial distribution functions", partialsMethod_, TRModule::partialsMethods());
...
EnumOptions<TRModule::PartialsMethod> TRModule::partialsMethods()
{
    return EnumOptions<TRModule::PartialsMethod>("PartialsMethod", {{TRModule::AutoMethod, "Auto"},
                                                                    {TRModule::CellsMethod, "Cells"},
                                                                    {TRModule::SimpleMethod, "Simple"},
                                                                    {TRModule::TestMethod, "Test"}});
}
