...
class TRModule : public Module
{
    ...
    EnumOptions<TRModule::PartialsMethod> partialsMethods();
    ...
    TRModule::PartialsMethod partialsMethod_{TRModule::AutoMethod};
    ...
    bool calculateGR(GenericList &processingData, const ProcessPool &procPool, Configuration *cfg,
                     TRModule::PartialsMethod method, const double rdfRange, const double rdfBinWidth, bool &alreadyUpToDate);
