...
{
	// Distance
	keywords_.add("Distance", new GeometryListKeyword(distances_, Geometry::GeometryType::Distance), "Distance", "Define a distance between Atoms to be checked", "<i> <j> <referenceDistance>");
