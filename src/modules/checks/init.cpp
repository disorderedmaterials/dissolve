...
{
	// Distance
	keywords_.add("Distance", new GeometryListKeyword(distances_, Geometry::DistanceType), "Distance", "Define a distance between Atoms to be checked", "<i> <j> <referenceDistance>");
	...
	// Angle
	keywords_.add("Angle", new GeometryListKeyword(angles_, Geometry::AngleType), "Angle", "Define an angle between Atoms to be checked", "<i> <j> <k> <referenceAngle>");
