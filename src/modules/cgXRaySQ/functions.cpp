...
bool CGXRaySQModule::calculateWeightedGR(const PartialSet &unweightedgr, PartialSet &weightedgr, const CGXRayWeights &weights,
...
bool CGXRaySQModule::calculateWeightedSQ(const PartialSet &unweightedsq, PartialSet &weightedsq, const CGXRayWeights &weights,
                                       StructureFactors::NormalisationType normalisation)
{
    int typeI, typeJ;
...
void CGXRaySQModule::calculateWeights(const GRModule *rdfModule, CGXRayWeights &weights,
