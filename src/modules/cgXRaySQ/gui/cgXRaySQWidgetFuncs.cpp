...
CGXRaySQModuleWidget::CGXRaySQModuleWidget(QWidget *parent, CGXRaySQModule *module, Dissolve &dissolve)
...
void CGXRaySQModuleWidget::createPartialSetRenderables(std::string_view targetPrefix)
{
    if (!targetPartials_)
        return;
...
void CGXRaySQModuleWidget::updateControls(const Flags<ModuleWidget::UpdateFlags> &updateFlags)
{
    refreshing_ = true;
...
void CGXRaySQModuleWidget::on_TotalFQButton_clicked(bool checked)
{
    if (!checked)
        return;
...
void CGXRaySQModuleWidget::on_PartialSQButton_clicked(bool checked)
{
    if (!checked)
        return;
...
void CGXRaySQModuleWidget::on_TotalGRButton_clicked(bool checked)
{
    if (!checked)
        return;
...
void CGXRaySQModuleWidget::on_PartialGRButton_clicked(bool checked)
{
    if (!checked)
        return;
...
void CGXRaySQModuleWidget::on_FilterEdit_textChanged(QString text) { updateControls(ModuleWidget::RecreateRenderablesFlag); }

void CGXRaySQModuleWidget::on_ClearFilterButton_clicked(bool checked)
{
