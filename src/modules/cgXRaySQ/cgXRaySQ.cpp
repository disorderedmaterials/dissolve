...
CGXRaySQModule::CGXRaySQModule() : Module(ModuleTypes::XRaySQ)
{
    keywords_.addTarget<ModuleKeyword<const SQModule>>(
        "SourceSQs", "Source unweighted S(Q) to transform into coarse-grained xray-weighted S(Q)", sourceSQ_, ModuleTypes::SQ);
...
const Data1DImportFileFormat &CGXRaySQModule::referenceFQFileAndFormat() { return referenceFQ_; }
