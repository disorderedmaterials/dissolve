...
void IntraShakeModule::initialise()
{
	...
	keywords_.add("Bonds", new DoubleKeyword(0.001), "BondStepSizeMin",
		      "Minimum step size for Bond adjustments (Angstroms)", "<stepsize>");
	...
	keywords_.add("Angles", new DoubleKeyword(5.0), "AngleStepSize", "Step size for Angle adjustments (degrees)",
		      "<stepsize>", KeywordBase::InRestartFileOption);
	keywords_.add("Angles", new DoubleKeyword(0.01), "AngleStepSizeMin",
		      "Minimum step size for Angle adjustments (degrees)", "<stepsize>");
	keywords_.add("Angles", new DoubleKeyword(20.0), "AngleStepSizeMax",
		      "Maximum step size for Angle adjustments (degrees)", "<stepsize>");
