...
void RDFModuleWidget::addPartialSetToTree(PartialSet& partials, QTreeWidgetItem* topLevelItem, RDFModuleWidget::DataType rootType, const char* rootTitle, int addAverageContributions)
{
