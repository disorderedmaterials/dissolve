...
class RDFModuleWidget : public ModuleWidget
{
	...
	void addPartialSetToTree(PartialSet& partials, QTreeWidgetItem* topLevelItem, RDFModuleWidget::DataType rootType, const char* rootTitle, int addAverageContributions = 0);
