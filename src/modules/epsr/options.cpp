...
void EPSRModule::setUpKeywords()
{
	...
	group->add(new EnumOptionsModuleKeyword<EPSRModule::ExpansionFunctionType>(EPSRModule::expansionFunctionTypes() = EPSRModule::PoissonExpansionFunction), "ExpansionFunction", "Form of expansion function to use when fitting difference data");
