...
void EPSRModule::initialise()
{
	...
	keywords_.add("Expansion Function", new IntegerKeyword(1000, 0), "NPItSs",
	...
	// Export
	keywords_.add("Export", new BoolKeyword(false), "SaveDifferenceFunctions",
		      "Whether to save difference function and fit", "<True|False>");
