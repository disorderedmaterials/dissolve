...
void MolShakeModule::initialise()
{
    ...
    keywords_.add("Control", new IntegerKeyword(1), "ShakesPerMolecule", "Number of shakes to attempt per molecule");
    ...
    keywords_.add("Control", new DoubleKeyword(3.0), "TranslationStepSizeMax",
