...
void RefineModuleWidget::updateControls(const Flags<ModuleWidget::UpdateFlags> &updateFlags)
{
    refreshing_ = true;
...
void RefineModuleWidget::on_TotalFQButton_clicked(bool checked)
{
    if (!checked)
        return;
...
void RefineModuleWidget::on_DeltaFQButton_clicked(bool checked)
{
    if (!checked)
        return;
...
void RefineModuleWidget::on_EstimatedSQButton_clicked(bool checked)
{
    if (!checked)
        return;
...
void RefineModuleWidget::on_EstimatedGRButton_clicked(bool checked)
{
    if (!checked)
        return;
...
void RefineModuleWidget::on_TotalGRButton_clicked(bool checked)
{
    if (!checked)
        return;
...
void RefineModuleWidget::on_PotentialsButton_clicked(bool checked)
{
    if (!checked)
        return;
...
void RefineModuleWidget::on_RFactorButton_clicked(bool checked)
{
    if (!checked)
        return;
...
void RefineModuleWidget::on_EReqButton_clicked(bool checked)
{
    if (!checked)
        return;
