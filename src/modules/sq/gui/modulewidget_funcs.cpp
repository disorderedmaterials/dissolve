...
// Constructor
SQModuleWidget::SQModuleWidget(QWidget* parent, Module* module, DUQ& dUQ) : ModuleWidget(parent), module_(module), dUQ_(dUQ)
{
...
void SQModuleWidget::addPartialSetToTree(PartialSet& partials, QTreeWidgetItem* topLevelItem, SQModuleWidget::DataType rootType, const char* rootTitle, int addAverageContributions)
{
...
// 			MimeTreeWidgetItem* fullItem = new MimeTreeWidgetItem(setItem, rootType+SQModuleWidget::FullData);
...
// 			// -- Bound partial
// 			MimeTreeWidgetItem* subItem = new MimeTreeWidgetItem(fullItem, rootType+SQModuleWidget::BoundData);
...
// 
// 			// -- Unbound partial
// 			subItem = new MimeTreeWidgetItem(fullItem, rootType+SQModuleWidget::UnboundData);
...
// 
// 			// -- Bragg partial
// 			subItem = new MimeTreeWidgetItem(fullItem, rootType+SQModuleWidget::BraggData);
...
// 				block += " EndCollection";
// 				subItem = new MimeTreeWidgetItem(fullItem, rootType+SQModuleWidget::FullData);
...
void SQModuleWidget::repopulateSourceTree()
{
// 	// Clear the tree
...
// 
// 			addPartialSetToTree(unweightedgr, cfgItem, SQModuleWidget::UnweightedGRData, "Unweighted g(r)", maxSetsInAverage);
// 		}
// 
...
// 
// 			addPartialSetToTree(unweightedsq, cfgItem, SQModuleWidget::UnweightedSQData, "Unweighted S(Q)");
// 		}
// 	}
}

void SQModuleWidget::on_SourcesTree_itemDoubleClicked(QTreeWidgetItem* item, int column)
{
	if (item == NULL) return;
