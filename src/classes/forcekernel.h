...
class ForceKernel
{
    ...
    void forces(const std::shared_ptr<Atom> onlyThis, const SpeciesBond &bond, const std::shared_ptr<Atom> i, const std::shared_ptr<Atom> j);
    ...
    void forces(const SpeciesAngle &angle, const std::shared_ptr<Atom> i, const std::shared_ptr<Atom> j, const std::shared_ptr<Atom> k);
    // Calculate SpeciesAngle forces
    void forces(const SpeciesAngle &angle);
    // Calculate SpeciesAngle forces for specified Atom only
    void forces(const std::shared_ptr<Atom> onlyThis, const SpeciesAngle &angle, const std::shared_ptr<Atom> i, const std::shared_ptr<Atom> j, const std::shared_ptr<Atom> k);
    ...
    void forces(const SpeciesTorsion &torsion, const std::shared_ptr<Atom> i, const std::shared_ptr<Atom> j, const std::shared_ptr<Atom> k, const std::shared_ptr<Atom> l);
    // Calculate SpeciesTorsion forces
    void forces(const SpeciesTorsion &torsion);
    // Calculate SpeciesTorsion forces for specified Atom only
    void forces(const std::shared_ptr<Atom> onlyThis, const SpeciesTorsion &torsion, const std::shared_ptr<Atom> i, const std::shared_ptr<Atom> j, const std::shared_ptr<Atom> k,
                const std::shared_ptr<Atom> l);
    // Calculate SpeciesImproper forces
    void forces(const SpeciesImproper &torsion, const std::shared_ptr<Atom> i, const std::shared_ptr<Atom> j, const std::shared_ptr<Atom> k, const std::shared_ptr<Atom> l);
    // Calculate SpeciesImproper forces
    void forces(const SpeciesImproper &torsion);
    // Calculate SpeciesImproper forces for specified Atom only
    void forces(const std::shared_ptr<Atom> onlyThis, const SpeciesImproper &torsion, const std::shared_ptr<Atom> i, const std::shared_ptr<Atom> j, const std::shared_ptr<Atom> k,
                const std::shared_ptr<Atom> l);
