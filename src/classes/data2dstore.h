...
class Data2DStore
{
    ...
    std::vector<std::reference_wrapper<std::pair<Data2D, Data2DImportFileFormat>>> data_;
    ...
    const std::vector<std::reference_wrapper<std::pair<Data2D, Data2DImportFileFormat>>> &data() const;
};
