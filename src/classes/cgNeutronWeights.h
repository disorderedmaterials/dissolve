...
#include "classes/cgBeads.h"
#include "classes/neutronWeights.h"


// Coarse-Grained Neutron Weights Container
class CGNeutronWeights
{
    public:
    CGNeutronWeights();
    CGNeutronWeights(const CGNeutronWeights &source);
    void operator=(const CGNeutronWeights &source);

    // CGNeutronWeights(const NeutronWeights &source);
    ...
    // Additional CG data (work in progress)
    public:
    CGBeadMap beadMap_;
