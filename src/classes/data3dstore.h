...
class Data3DStore
{
    ...
    std::vector<std::reference_wrapper<std::pair<Data3D, Data3DImportFileFormat>>> data_;
    ...
    const std::vector<std::reference_wrapper<std::pair<Data3D, Data3DImportFileFormat>>> &data() const;
};
