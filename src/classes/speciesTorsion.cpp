...
void SpeciesTorsion::serialise(std::string name, SerialisedValue &target) const
{
    SpeciesIntra<SpeciesTorsion, TorsionFunctions>::serialise(name, target);
    auto &torsion = target[name];
    if (i_ != nullptr)
