...
Vec3<double> NonPeriodicBox::minimumImage(const std::shared_ptr<Atom> i, const std::shared_ptr<Atom> ref) const { return i->r(); }
...
Vec3<double> NonPeriodicBox::minimumVector(const std::shared_ptr<Atom> i, const std::shared_ptr<Atom> j) const { return j->r() - i->r(); }
...
double NonPeriodicBox::minimumDistance(const std::shared_ptr<Atom> i, const std::shared_ptr<Atom> j) const { return (j->r() - i->r()).magnitude(); }

// Return minimum image distance from 'i' to 'j'
double NonPeriodicBox::minimumDistance(const Atom &i, const Atom &j) const { return (j.r() - i.r()).magnitude(); }

// Return minimum image distance from 'i' to 'j'
double NonPeriodicBox::minimumDistance(const std::shared_ptr<Atom> i, const Vec3<double> &j) const { return (j - i->r()).magnitude(); }
...
double NonPeriodicBox::minimumDistanceSquared(const std::shared_ptr<Atom> i, const std::shared_ptr<Atom> j) const { return (j->r() - i->r()).magnitudeSq(); }
...
double NonPeriodicBox::minimumDistanceSquared(const std::shared_ptr<Atom> i, const Vec3<double> &j) const { return (j - i->r()).magnitudeSq(); }
