...
class PairPotential : Serialisable<>
{
    ...
    public:
    // Return the current core definitions version
    static const VersionCounter &coreDefinitionsVersion();
    // Set pair potential range and delta
    static void setRange(double range, std::optional<double> delta = {});
    ...
    void setLocalChargeProduct(double qiqj);
     ...
     */
    private:
    // Version at which the last tabulation was made
