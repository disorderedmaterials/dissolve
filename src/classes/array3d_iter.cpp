...
bool Array3DIterator::operator==(const Array3DIterator &other) const {return x_ == other.x_ && y_ == other.y_ && z_ == other.z_;}
bool Array3DIterator::operator!=(const Array3DIterator &other) const {return x_ != other.x_ || y_ != other.y_ || z_ != other.z_;}
...
Array3DIterator::difference_type Array3DIterator::operator-(const Array3DIterator &other) const { return toIndex() - other.toIndex(); }

Array3DIterator Array3DIterator::operator+(Array3DIterator::difference_type diff) const { return Array3DIterator(sizeX_, sizeY_, sizeZ_, diff + toIndex()); } 
