...
class Data1DStore
{
    ...
    std::vector<std::reference_wrapper<std::pair<Data1D, Data1DImportFileFormat>>> data_;
    ...
    const std::vector <std::reference_wrapper<std::pair<Data1D, Data1DImportFileFormat>>> &data() const;
};
