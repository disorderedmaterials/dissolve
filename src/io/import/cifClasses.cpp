...
bool CIFSpecies::createMolecularSpecies()
{
    ...
    Messenger::print("Generated molecular species");
    return true;
}
...
Configuration *CIFSpecies::molecularConfiguration(CoreData &coreData)
{
...
Configuration *CIFSpecies::partitionedConfiguration()
{
