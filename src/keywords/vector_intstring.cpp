...
IntegerStringVectorKeyword::IntegerStringVectorKeyword(int nRequiredIntegers, std::optional<int> nRequiredValues)
    : KeywordData<IntegerStringVectorKeywordData>(KeywordBase::VectorIntegerStringData, {}),
