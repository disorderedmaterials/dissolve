...
void Function1DKeyword::serialise(std::string name, SerialisedValue &target) const
{
    target[name] = {{"type", Functions1D::forms().serialise(data_.form())}, {"parameters", data_.parameters()}};
}
