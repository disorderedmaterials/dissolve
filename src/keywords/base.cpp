...
const char* KeywordDataTypeKeywords[] = { "AtomTypeSelection", "Bool", "BroadeningFunction", "CharString", "Complex", "Data1DStore", "Data2DStore", "Data3DStore", "Double", "EnumOptions", "ExpressionVariableList", "FileAndFormat", "Integer", "IsotopologueList", "ModuleGroups", "ModuleRefList", "Node", "NodeAndInteger", "NodeBranch", "NodeRefList", "NodeValue", "NodeValueEnumOptions", "PairBroadeningFunction", "Procedure", "Species", "SpeciesRefList", "SpeciesSite", "SpeciesSiteRefList", "Vec3<Double>", "Vec3<Integer>", "Vec3<NodeValue>", "WindowFunction" };
