...
constexpr std::pair<int, double> massData_[] = {
    {ELEMENT_XX, 0.0},          // Unknown element
    {ELEMENT_H, 1.00798175},    // Uncertainty = (1), VSMOW
    {ELEMENT_HE, 4.002602},     // Uncertainty = (2)
    {ELEMENT_LI, 6.9675},       // Average of {6.938, 6.997}
    {ELEMENT_BE, 9.0121831},    // Uncertainty = (5)
    {ELEMENT_B, 10.8135},       // Average of {10.806, 10.821}
    {ELEMENT_C, 12.0106},       // Average of {12.0096, 12.0116}
    {ELEMENT_N, 14.0069},       // Average of {14.00643, 14.00728}
    {ELEMENT_O, 15.9994},       // Average of {15.99903, 15.99977}
    {ELEMENT_F, 18.998403163},  // Uncertainty = (6)
    {ELEMENT_NE, 20.1797},      // Uncertainty = (6)
    {ELEMENT_NA, 22.98976928},  // Uncertainty = (2)
    {ELEMENT_MG, 24.3055},      // Average of {24.304, 24.307}
    {ELEMENT_AL, 26.9815384},   // Uncertainty = (3)
    {ELEMENT_SI, 28.085},       // Average of {28.084, 28.086}
    {ELEMENT_P, 30.973761998},  // Uncertainty = (5)
    {ELEMENT_S, 32.0675},       // Average of {32.059, 32.076}
    {ELEMENT_CL, 35.4515},      // Average of {35.446, 35.457}
    {ELEMENT_AR, 39.8775},      // Average of {39.792, 39.963}
    ...
    {ELEMENT_BR, 79.904},       // Average of {79.901, 79.907}
    ...
    {ELEMENT_TL, 204.383},      // Average of {204.382, 204.385}
