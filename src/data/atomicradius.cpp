...
// Constructor
AtomicRadiusData::AtomicRadiusData(int z, double radius) : ElementReference(z)
{
	radius_ = radius;
}

// Return radius of element
double AtomicRadiusData::radius() const
{
	return radius_;
}
...
double AtomicRadius::radius(int Z)
{
	return radiusData(Z).radius();
}
