...
List<UFFAtomType>& Forcefield_UFF::atomTypesByElement(int Z)
{
	...
	static UFFAtomType uffData[] =
	{
		...
		{ 1,	"H",	1,	"H_",		"Generic hydrogen",
							0.3540,	180.00,	2.8860,	0.0440,	12.000,	0.7120,	4.528,	0,	0.0,	0.0 },
		{ 1,	"H",	2,	"H_b",		"Bridging hydrogen in B-H-B",
