...
const std::vector<UFFAtomType> &Forcefield_UFF::uffAtomTypes() const
{
    static const std::vector<UFFAtomType> atomTypes = {
        ...
        // U
        {ELEMENT_H, 1, "H_", "", "Generic hydrogen", 0.3540, 180.00, 2.8860, 0.0440, 12.000, 0.7120, 4.528, 0, 0.0,
         0.0},
        {ELEMENT_H, 2, "H_b", "", "Bridging hydrogen in B-H-B", 0.4600, 83.50, 2.8860, 0.0440, 12.000, 0.7125, 4.528,
         8, 0.0, 0.0},
        ...
        {ELEMENT_B, 6, "B_3", "", "Boron (tetrahedral)", 0.8380, 109.47, 4.0830, 0.1800, 12.052, 1.7550, 5.11, 3, 0.0,
         2.0},
        {ELEMENT_B, 7, "B_2", "", "Boron (trigonal)", 0.8280, 120.00, 4.0830, 0.1800, 12.052, 1.7550, 5.11, 2, 0.0,
         2.0},
        {ELEMENT_C, 8, "C_3", "", "Carbon (tetrahedral)", 0.7570, 109.47, 3.8510, 0.1050, 12.730, 1.9120, 5.343, 3,
         2.119, 2.0},
        {ELEMENT_C, 9, "C_R", "", "Carbon (resonant)", 0.7290, 120.00, 3.8510, 0.1050, 12.730, 1.9120, 5.343, 9, 0.0,
         2.0},
        {ELEMENT_C, 10, "C_2", "", "Carbon (trigonal)", 0.7320, 120.00, 3.8510, 0.1050, 12.730, 1.9120, 5.343, 2, 0.0,
         2.0},
        {ELEMENT_C, 11, "C_1", "", "Carbon (linear)", 0.7060, 180.00, 3.8510, 0.1050, 12.730, 1.9120, 5.343, 1, 0.0,
         2.0},
        {ELEMENT_N, 12, "N_3", "", "Nitrogen (tetrahedral)", 0.7000, 106.70, 3.6600, 0.0690, 13.407, 2.5438, 6.899, 3,
         0.450, 0.0},
        {ELEMENT_N, 13, "N_R", "", "Nitrogen (resonant)", 0.6990, 120.00, 3.6600, 0.0690, 13.407, 2.5438, 6.899, 9,
         0.0, 2.0},
        {ELEMENT_N, 14, "N_2", "", "Nitrogen (trigonal)", 0.6850, 111.30, 3.6600, 0.0690, 13.407, 2.5438, 6.899, 2,
         0.0, 2.0},
        {ELEMENT_N, 15, "N_1", "", "Nitrogen (linear)", 0.6560, 180.00, 3.6600, 0.0690, 13.407, 2.5438, 6.899, 1, 0.0,
         2.0},
        {ELEMENT_O, 16, "O_3", "", "Oxygen (tetrahedral)", 0.6580, 104.51, 3.5000, 0.0600, 14.085, 2.2998, 8.741, 3,
         0.018, 2.0},
        {ELEMENT_O, 17, "O_3_z", "", "Oxygen (in silicate)", 0.5280, 145.50, 3.5000, 0.0600, 14.085, 2.2998, 8.741, 3,
         0.018, 2.0},
        {ELEMENT_O, 18, "O_R", "", "Oxygen (resonant)", 0.6800, 110.30, 3.5000, 0.0600, 14.085, 2.2998, 8.741, 9, 0.0,
         2.0},
        {ELEMENT_O, 19, "O_2", "", "Oxygen (trigonal)", 0.6340, 120.00, 3.5000, 0.0600, 14.085, 2.2998, 8.741, 2, 0.0,
         2.0},
        {ELEMENT_O, 20, "O_1", "", "Oxygen (linear)", 0.6390, 180.00, 3.5000, 0.0600, 14.085, 2.2998, 8.741, 1, 0.0,
         2.0},
        ...
        {ELEMENT_MG, 24, "Mg3+2", "", "Magnesium", 1.4210, 109.47, 3.0210, 0.1110, 12.000, 1.7866, 3.951, 3, 0.0,
         1.25},
        ...
        {ELEMENT_P, 27, "P_3+3", "", "Phosphorus (tetrahedral, oxidation state +3)", 1.1010, 93.80, 4.1470, 0.3050,
         13.072, 2.8627, 5.463, 3, 2.4, 1.25},
        {ELEMENT_P, 28, "P_3+5", "", "Phosphorus (tetrahedral, oxidation state +5)", 1.0560, 109.47, 4.1470, 0.3050,
         13.072, 2.8627, 5.463, 3, 2.4, 1.25},
        {ELEMENT_P, 29, "P_3+q", "", "XXX", 1.0560, 109.47, 4.1470, 0.3050, 13.072, 2.8627, 5.463, 3, 2.4, 1.25},
        {ELEMENT_S, 30, "S_3+2", "", "Sulfur (tetrahedral, oxidation state +2)", 1.0640, 92.10, 4.0350, 0.2740, 13.969,
         2.7032, 6.928, 3, 0.484, 1.25},
        {ELEMENT_S, 31, "S_3+4", "", "Sulfur (tetrahedral, oxidation state +4)", 1.0490, 103.20, 4.0350, 0.2740,
         13.969, 2.7032, 6.928, 3, 0.484, 1.25},
        {ELEMENT_S, 32, "S_3+6", "", "Sulfur (tetrahedral, oxidation state +6)", 1.0270, 109.47, 4.0350, 0.2740,
         13.969, 2.7032, 6.928, 3, 0.484, 1.25},
        {ELEMENT_S, 33, "S_R", "", "Sulfur (resonant)", 1.0770, 92.20, 4.0350, 0.2740, 13.969, 2.7032, 6.928, 9, 0.0,
         1.25},
        {ELEMENT_S, 34, "S_2", "", "Sulfur (trigonal)", 0.8540, 120.00, 4.0350, 0.2740, 13.969, 2.7032, 6.928, 2, 0.0,
         1.25},
        ...
        {ELEMENT_CA, 38, "Ca6+2", "", "Calcium (octahedral, oxidation state +2)", 1.7610, 90.00, 3.3990, 0.2380,
         12.000, 2.1414, 3.231, 6, 0.0, 0.7},
        {ELEMENT_SC, 39, "Sc3+3", "", "Scandium (tetrahedral, oxidation state +3)", 1.5130, 109.47, 3.2950, 0.0190,
         12.000, 2.5924, 3.395, 3, 0.0, 0.7},
        {ELEMENT_TI, 40, "Ti3+4", "", "Titanium (tetrahedral, oxidation state +4)", 1.4120, 109.47, 3.1750, 0.0170,
         12.000, 2.6595, 3.47, 3, 0.0, 0.7},
        {ELEMENT_TI, 41, "Ti6+4", "", "Titanium (octahedral, oxidation state +4)", 1.4120, 90.00, 3.1750, 0.0170,
        ...
        {ELEMENT_FE, 45, "Fe3+2", "", "Iron (tetrahedral, oxidation state +2)", 1.4120, 109.47, 2.9120, 0.0130, 12.000,
         2.4301, 3.76, 3, 0.0, 0.7},
        {ELEMENT_FE, 46, "Fe6+2", "", "Iron (octahedral, oxidation state +2)", 1.3350, 90.00, 2.9120, 0.0130, 12.000,
         2.4301, 3.76, 6, 0.0, 0.7},
        {ELEMENT_CO, 47, "Co6+3", "", "Cobalt (octahedral, oxidation state +3)", 1.2410, 90.00, 2.8720, 0.0140, 12.000,
        ...
        {ELEMENT_GA, 51, "Ga3+3", "", "Gallium (tetrahedral, oxidation state +3)", 1.2600, 109.47, 4.3830, 0.4150,
         11.000, 1.8206, 3.641, 3, 0.0, 0.7},
        {ELEMENT_GE, 52, "Ge3", "", "Germanium", 1.1970, 109.47, 4.2800, 0.3790, 12.000, 2.7888, 4.051, 3, 0.701, 0.0},
        {ELEMENT_AS, 53, "As3+3", "", "Astatine (tetrahedral, oxidation state +3)", 1.2110, 92.10, 4.2300, 0.3090,
        ...
        {ELEMENT_Y, 59, "Y_3+3", "", "Yttrium (tetrahedral, oxidation state +3)", 1.6980, 109.47, 3.3450, 0.0720,
        ...
        {ELEMENT_MO, 62, "Mo6+6", "", "Molybdenum (octahedral)", 1.4670, 90.00, 3.0520, 0.0560, 12.000, 3.4021, 3.465,
         6, 0.0, 0.2},
        {ELEMENT_MO, 63, "Mo3+6", "", "Molybdenum (tetrahedral)", 1.4840, 109.47, 3.0520, 0.0560, 12.000, 3.4021,
         3.465, 3, 0.0, 0.2},
        ...
        {ELEMENT_RH, 66, "Rh6+3", "", "Rhodium (octahedral, oxidation state +3)", 1.3320, 90.00, 2.9290, 0.0530,
         12.000, 3.5081, 3.975, 6, 0.0, 0.2},
        {ELEMENT_PD, 67, "Pd4+2", "", "Palladium", 1.3380, 90.00, 2.8990, 0.0480, 12.000, 3.2077, 4.32, 4, 0.0, 0.2},
        {ELEMENT_AG, 68, "Ag1+1", "", "Silver (linear, oxidation state +1)", 1.3860, 180.00, 3.1480, 0.0360, 12.000,
         1.9557, 4.436, 1, 0.0, 0.2},
        {ELEMENT_CD, 69, "Cd3+2", "", "Cadmium", 1.4030, 109.47, 2.8480, 0.2280, 12.000, 1.6525, 5.034, 3, 0.0, 0.2},
        {ELEMENT_IN, 70, "In3+3", "", "Indium (tetrahedral, oxidation state +3)", 1.4590, 109.47, 4.4630, 0.5990,
         11.000, 2.0704, 3.506, 3, 0.0, 0.2},
        {ELEMENT_SN, 71, "Sn3", "", "Tin", 1.3980, 109.47, 4.3920, 0.5670, 12.000, 2.9608, 3.987, 3, 0.199, 0.2},
        {ELEMENT_SB, 72, "Sb3+3", "", "Antimony (tetrahedral, oxidation state +3)", 1.4070, 91.60, 4.4200, 0.4490,
        ...
        {ELEMENT_LA, 78, "La3+3", "", "Lanthanum (tetrahedral, oxidation state +3)", 1.9430, 109.47, 3.5220, 0.0170,
         12.000, 3.3049, 2.8355, 3, 0.0, 0.1},
        {ELEMENT_CE, 79, "Ce6+3", "", "Cerium (octahedral, oxidation state +3)", 1.8410, 90.00, 3.5560, 0.0130, 12.000,
         3.3049, 2.774, 6, 0.0, 0.1},
        {ELEMENT_PR, 80, "Pr6+3", "", "Praseodymium (octahedral, oxidation state +3)", 1.8230, 90.00, 3.6060, 0.0100,
         12.000, 3.3049, 2.858, 6, 0.0, 0.1},
        {ELEMENT_ND, 81, "Nd6+3", "", "Neodymium (octahedral, oxidation state +3)", 1.8160, 90.00, 3.5750, 0.0100,
         12.000, 3.3049, 2.8685, 6, 0.0, 0.1},
        {ELEMENT_PM, 82, "Pm6+3", "", "Prometheum (octahedral, oxidation state +3)", 1.8010, 90.00, 3.5470, 0.0090,
         12.000, 3.3049, 2.881, 6, 0.0, 0.1},
        {ELEMENT_SM, 83, "Sm6+3", "", "Samarium (octahedral, oxidation state +3)", 1.7800, 90.00, 3.5200, 0.0080,
         12.000, 3.3049, 2.9115, 6, 0.0, 0.1},
        {ELEMENT_EU, 84, "Eu6+3", "", "Europium (octahedral, oxidation state +3)", 1.7710, 90.00, 3.4930, 0.0080,
         12.000, 3.3049, 2.8785, 6, 0.0, 0.1},
        {ELEMENT_GD, 85, "Gd6+3", "", "Gadolinium (octahedral, oxidation state +3)", 1.7350, 90.00, 3.3680, 0.0090,
         12.000, 3.3049, 3.1665, 6, 0.0, 0.1},
        {ELEMENT_TB, 86, "Tb6+3", "", "Terbium (octahedral, oxidation state +3)", 1.7320, 90.00, 3.4510, 0.0070,
         12.000, 3.3049, 3.018, 6, 0.0, 0.1},
        {ELEMENT_DY, 87, "Dy6+3", "", "Dysprosium (octahedral, oxidation state +3)", 1.7100, 90.00, 3.4280, 0.0070,
         12.000, 3.3049, 3.0555, 6, 0.0, 0.1},
        {ELEMENT_HO, 88, "Ho6+3", "", "Holmium (octahedral, oxidation state +3)", 1.6960, 90.00, 3.4090, 0.0070,
         12.000, 3.4157, 3.127, 6, 0.0, 0.1},
        {ELEMENT_ER, 89, "Er6+3", "", "Erbium (octahedral, oxidation state +3)", 1.6730, 90.00, 3.3910, 0.0070, 12.000,
         3.3049, 3.1865, 6, 0.0, 0.1},
        {ELEMENT_TM, 90, "Tm6+3", "", "Thulium (octahedral, oxidation state +3)", 1.6600, 90.00, 3.3740, 0.0060,
         12.000, 3.3049, 3.2514, 6, 0.0, 0.1},
        {ELEMENT_YB, 91, "Yb6+3", "", "Ytterbium (octahedral, oxidation state +3)", 1.6370, 90.00, 3.3550, 0.2280,
         12.000, 2.6177, 3.2889, 6, 0.0, 0.1},
        {ELEMENT_LU, 92, "Lu6+3", "", "Lutetium (octahedral, oxidation state +3)", 1.6710, 90.00, 3.6400, 0.0410,
         12.000, 3.2709, 2.9629, 6, 0.0, 0.1},
        {ELEMENT_HF, 93, "Hf3+4", "", "Hafnium (tetrahedral, oxidation state +4)", 1.6110, 109.47, 3.1410, 0.0720,
         12.000, 3.9212, 3.7, 3, 0.0, 0.1},
        {ELEMENT_TA, 94, "Ta3+5", "", "Tantalum (tetrahedral, oxidation state +5)", 1.5110, 109.47, 3.1700, 0.0810,
         12.000, 4.0748, 5.1, 3, 0.0, 0.1},
        {ELEMENT_W, 95, "W_6+6", "", "Tungsten (octahedral, oxidation state +6)", 1.3920, 90.00, 3.0690, 0.0670,
         12.000, 3.6937, 4.63, 6, 0.0, 0.1},
        {ELEMENT_W, 96, "W_3+4", "", "Tungsten (tetrahedral, oxidation state +4)", 1.5260, 109.47, 3.0690, 0.0670,
         12.000, 3.6937, 4.63, 3, 0.0, 0.1},
        {ELEMENT_W, 97, "W_3+6", "", "Tungsten (tetrahedral, oxidation state +6)", 1.3800, 109.47, 3.0690, 0.0670,
         12.000, 3.6937, 4.63, 3, 0.0, 0.1},
        {ELEMENT_RE, 98, "Re6+5", "", "Rhenium (octahedral, oxidation state +5)", 1.3720, 90.00, 2.9540, 0.0660,
         12.000, 3.6937, 3.96, 6, 0.0, 0.1},
        {ELEMENT_RE, 99, "Re3+7", "", "Rhenium (tetrahedral, oxidation state +7)", 1.3140, 109.47, 2.9540, 0.0660,
         12.000, 3.6937, 3.96, 3, 0.0, 0.1},
        {ELEMENT_OS, 100, "Os6+6", "", "Osmium (octahedral, oxidation state +6)", 1.3720, 90.00, 3.1200, 0.0370,
         12.000, 3.6937, 5.14, 6, 0.0, 0.1},
        {ELEMENT_IR, 101, "Ir6+3", "", "Iridium (octahedral, oxidation state +3)", 1.3710, 90.00, 2.8400, 0.0730,
        ...
        {ELEMENT_TL, 105, "Tl3+3", "", "Thallium (tetrahedral, oxidation state +3)", 1.5180, 120.00, 4.3470, 0.6800,
         11.000, 2.0685, 3.2, 3, 0.0, 0.1},
        {ELEMENT_PB, 106, "Pb3", "", "Lead", 1.4590, 109.47, 4.2970, 0.6630, 12.000, 2.8461, 3.9, 3, 0.1, 0.1},
        {ELEMENT_BI, 107, "Bi3+3", "", "Bismuth (tetrahedral, oxidation state +3)", 1.5120, 90.00, 4.3700, 0.5180,
         13.000, 2.4700, 4.69, 3, 1.0, 0.1},
        {ELEMENT_PO, 108, "Po3+2", "", "Polonium (tetrahedral, oxidation state +2)", 1.5000, 90.00, 4.7090, 0.3250,
        ...
        {ELEMENT_RA, 112, "Ra6+2", "", "Radium (octahedral, oxidation state +2)", 2.5120, 90.00, 3.6770, 0.4040,
         12.000, 2.9161, 2.843, 6, 0.0, 0.0},
        {ELEMENT_AC, 113, "Ac6+3", "", "Actinium (octahedral, oxidation state +3)", 1.9830, 90.00, 3.4780, 0.0330,
         12.000, 3.8882, 2.835, 6, 0.0, 0.0},
        {ELEMENT_TH, 114, "Th6+4", "", "Thorium (octahedral, oxidation state +4)", 1.7210, 90.00, 3.3960, 0.0260,
         12.000, 4.2021, 3.175, 6, 0.0, 0.0},
        {ELEMENT_PA, 115, "Pa6+4", "", "Protactinium (octahedral, oxidation state +4)", 1.7110, 90.00, 3.4240, 0.0220,
         12.000, 3.8882, 2.985, 6, 0.0, 0.0},
        {ELEMENT_U, 116, "U_6+4", "", "Uranium (octahedral, oxidation state +4)", 1.6840, 90.00, 3.3950, 0.0220,
         12.000, 3.8882, 3.341, 6, 0.0, 0.0},
        {ELEMENT_NP, 117, "Np6+4", "", "Neptunium (octahedral, oxidation state +4)", 1.6660, 90.00, 3.4240, 0.0190,
         12.000, 3.8882, 3.549, 6, 0.0, 0.0},
        {ELEMENT_PU, 118, "Pu6+4", "", "Plutonium (octahedral, oxidation state +4)", 1.6570, 90.00, 3.4240, 0.0160,
         12.000, 3.8882, 3.243, 6, 0.0, 0.0},
        {ELEMENT_AM, 119, "Am6+4", "", "Americium (octahedral, oxidation state +4)", 1.6600, 90.00, 3.3810, 0.0140,
         12.000, 3.8882, 2.9895, 6, 0.0, 0.0},
        {ELEMENT_CM, 120, "Cm6+3", "", "Curium (octahedral, oxidation state +3)", 1.8010, 90.00, 3.3260, 0.0130,
         12.000, 3.8882, 2.8315, 6, 0.0, 0.0},
        {ELEMENT_BK, 121, "Bk6+3", "", "Berkelium (octahedral, oxidation state +3)", 1.7610, 90.00, 3.3390, 0.0130,
         12.000, 3.8882, 3.1935, 6, 0.0, 0.0},
        {ELEMENT_CF, 122, "Cf6+3", "", "Californium (octahedral, oxidation state +3)", 1.7500, 90.00, 3.3130, 0.0130,
         12.000, 3.8882, 3.197, 6, 0.0, 0.0},
        {ELEMENT_ES, 123, "Es6+3", "", "Einsteinium (octahedral, oxidation state +3)", 1.7240, 90.00, 3.2990, 0.0120,
         12.000, 3.8882, 3.333, 6, 0.0, 0.0},
        {ELEMENT_FM, 124, "Fm6+3", "", "Fermium (octahedral, oxidation state +3)", 1.7120, 90.00, 3.2860, 0.0120,
         12.000, 3.8882, 3.4, 6, 0.0, 0.0},
        {ELEMENT_MD, 125, "Md6+3", "", "Mendelevium (octahedral, oxidation state +3)", 1.6890, 90.00, 3.2740, 0.0110,
         12.000, 3.8882, 3.47, 6, 0.0, 0.0},
        {ELEMENT_NO, 126, "No6+3", "", "Nobelium (octahedral, oxidation state +3)", 1.6790, 90.00, 3.2480, 0.0110,
         12.000, 3.8882, 3.475, 6, 0.0, 0.0},
        {ELEMENT_LR, 127, "Lr6+3", "", "Lawrencium (octahedral, oxidation state +3)", 1.6980, 90.00, 3.2360, 0.0110,
