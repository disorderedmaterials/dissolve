...
// Constructor
UFFAtomType::UFFAtomType(Forcefield* parent, int z, int index, const char* name, const char* description, double r, double theta, double x, double D, double zeta, double Z, double chi, int geom, double V, double U) : ForcefieldAtomType(parent, z, index, name, description)
{
