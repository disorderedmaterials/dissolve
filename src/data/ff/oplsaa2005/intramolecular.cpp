...
{
	static std::vector<ForcefieldBondTerm> bondTerms = {//	i	j	Type (Harmonic)			k	eq
...
{
	static std::vector<ForcefieldAngleTerm> angleTerms = {//	i	j	k	Type (Harmonic)			k	eq
...
optional<const ForcefieldImproperTerm &> OPLSAA2005BaseForcefield::improperTerm(const ForcefieldAtomType *i, const ForcefieldAtomType *j, const ForcefieldAtomType *k,
