...
/*
 * OPLS-AA (2005) Intramolecular Terms
 */

// Constructor
OPLSAA2005IntramolecularTerms::OPLSAA2005IntramolecularTerms()
{
	...
	static ForcefieldAngleTerm angleTerms[] =
	{
		...
		{ this, "CT",	"C=",	"HC",	SpeciesAngle::HarmonicForm,	292.88,		120.0 },
...
const char* OPLSAA2005IntramolecularTerms::name() const
{
	return "OPLS-AA (2005) Intramolecular Terms Only";
}

// Return description for Forcefield
const char* OPLSAA2005IntramolecularTerms::description() const
{
	return "OPLS-AA (2005) Intramolecular Terms Only";
}

// Return short-range interaction style for AtomTypes
Forcefield::ShortRangeType OPLSAA2005IntramolecularTerms::shortRangeType() const
{
