...
bool Forcefield_UFF::assignTorsionTermParameters(SpeciesTorsion &torsion, bool determineTypes) const
{
             ...
             (groupK != 16 && geomK == '2' && groupJ == 16 && geomJ == '3'))
    {
        ...
        torsion.setParameters({4.184 * 5.0 * sqrt(j.parameter(UFFAtomTypeData::U) * k.parameter(UFFAtomTypeData::U)) *
    ...
    else if (geomJ == '3' && geomK == '3')
    {
        ...
        torsion.setParameters({4.184 * sqrt(j.parameter(UFFAtomTypeData::V) * k.parameter(UFFAtomTypeData::V)), 3.0, 180.0});
    }
