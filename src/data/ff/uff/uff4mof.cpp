...
bool Forcefield_UFF4MOF::setUp()
{
    uffAtomTypes_ = {
        ...
        {Elements::O, 203, "O_2_z", "nbonds=3, -[&204,&205,&208,&211,&213,&210]", "Oxygen (trigonal planar) in SBU", 0.528,
         120.0, 3.5, 0.06, 14.085, 2.3, 8.741, 0.0, 2.0},
        {Elements::Al, 204, "Al6+3", "nbonds=6, -&203", "Aluminium (octahedral, oxidation state = +3)", 1.22, 90.0, 4.499,
         0.505, 11.278, 1.792, 11.278, 0.0, 1.25},
        ...
        {Elements::Mn, 211, "Mn6+3", "nbonds=6, -&203", "Manganese (octahedral, oxidation state = +3)", 1.34, 90.0, 2.961,
         0.013, 12.0, 2.43, 3.325, 0.0, 0.7},
        ...
        {Elements::Fe, 214, "Fe4+2", "nbonds=4, -O(-&9)", "Iron (square planar, oxidation state = +2)", 1.10, 90.0, 2.912,
        ...
        {Elements::Co, 215, "Co3+2", "nbonds=4", "Cobalt (tetrahedral, oxidation state = +2)", 1.24, 109.47, 2.872, 0.014, 12.0,
         1.308, 4.105, 0.0, 0.7},
        {Elements::Co, 216, "Co4+2", "nbonds=4, -[O(-&9),&13]", "Cobalt (square planar, oxidation state = +3)", 1.16, 90.0,
        ...
        {Elements::Zn, 219, "Zn3f2", "-[&202,&13]", "Zinc (tetrahedral, oxidation state = +2)", 1.24, 109.47, 2.763, 0.124,
