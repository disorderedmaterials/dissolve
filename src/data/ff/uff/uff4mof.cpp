...
bool Forcefield_UFF4MOF::setUp()
{
    ...
    addUFFAtomType(Elements::Ti, 206, "Ti4+2", "nbonds>=5, -&223(n=2), -Ti(root)", "Titanium (oct/sqbp, oxidation state = +2)",
                   1.38, 90.0, 3.175, 0.017, 12.0, 2.659, 3.47, 0.0, 0.7);
    addUFFAtomType(Elements::V, 207, "V_4+2", "nbonds>=5, -&223(n=2), -V(root)", "Vanadium (oct/sqbp, oxidation state = +2)",
    ...
    addUFFAtomType(Elements::Cr, 209, "Cr4+2", "nbonds>=5, -&223(n=2), -Cr(root)", "Chromium (oct/sqbp, oxidation state = +2)",
    ...
    addUFFAtomType(Elements::Mn, 212, "Mn4+2", "nbonds>=5, -&223(n=2), -Mn(root)", "Manganese (oct/sqbp, oxidation state = +2)",
    ...
    addUFFAtomType(Elements::Fe, 214, "Fe4+2", "nbonds>=5, nbonds=6, -&223(n=2), -Fe(root)",
    ...
    addUFFAtomType(Elements::Co, 216, "Co4+2", "nbonds>=5, -&223(n=2), -Ti(root)", "Cobalt (oct/sqbp, oxidation state = +3)",
    ...
    addUFFAtomType(Elements::Co, 217, "Co4+2", "geometry=oct, nbonds=6, -&223(n=6)",
                   ...
                   0.7);
    addUFFAtomType(Elements::Cu, 218, "Cu4+2", "nbonds>=5, -&223(n=2), -Cu(root)", "Copper (oct/sqbp, oxidation state = +2)",
                   1.28, 90.0, 3.495, 0.005, 12.0, 2.43, 4.2, 0.0, 0.7);
    addUFFAtomType(Elements::Zn, 219, "Zn4+2", "nbonds>=5, -&223(n=2), -Zn(root)", "Zinc (oct/sqbp, oxidation state = +2)",
