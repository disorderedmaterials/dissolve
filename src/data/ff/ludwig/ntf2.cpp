...
Forcefield_NTf2::Forcefield_NTf2()
{
...
const char* Forcefield_NTf2::name() const
{
        return "NTf2";
}
...
{
        return "T. K&ouml;ddermann, D. Paschek, R. Ludwig,<em>ChemPhysChem</em> <b>8</b>, 2464-2470 (2007). changes: J. Neumann, B. Golub 03/2017, charges: MP2 cc-pvtz, dihedrals:      FCSN MP2 cc-pvtz and SNSC MP2 cc-pvtz (6 Functions)";
}

// Return short-range interaction style for AtomTypes
Forcefield::ShortRangeType Forcefield_NTf2::shortRangeType() const
{
