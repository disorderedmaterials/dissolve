/*
        *** Py4OH Forcefield
        *** src/data/ff/ludwig/py4oh_ludwig.cpp
...
{
        return "1‐(4‐hydroxybutyl)pyridinium (Py4OH)";
}
...
ForcefieldAtomType* Forcefield_Py4OH_Ludwig::determineAtomType(SpeciesAtom* i) const
{
        return NULL;
}
