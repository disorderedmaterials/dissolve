...
bool NETANode::addElementTarget(const Elements::Element &el)
{
...
NETANode::createConnectionNode(std::vector<std::reference_wrapper<const Elements::Element>> targetElements,
...
NETANode::createPresenceNode(std::vector<std::reference_wrapper<const Elements::Element>> targetElements,
                             std::vector<std::reference_wrapper<const ForcefieldAtomType>> targetAtomTypes)
{
