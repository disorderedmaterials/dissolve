...
void DissolveWindow::on_SimulationRunForAction_triggered(bool checked)
{
	...
	bool ok;
	int nIterations = QInputDialog::getInt(this, "Iterate Simulation...", "Enter the number of iterations to run", 10, 1,
					       1000000, 10, &ok);
	if (!ok)
		return;
...
void DissolveWindow::on_SimulationSetRandomSeedAction_triggered(bool checked)
{
	...
	bool ok;
	dissolve_.seed();
	int newSeed = QInputDialog::getInt(this, "Set random seed",
					   "Enter the new value of the random seed, or -1 to remove set value",
