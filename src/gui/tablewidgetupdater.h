...
template <class T, class I, class P> class TableWidgetUpdater
{
	...
	public:
	// Constructor
	TableWidgetUpdater(QTableWidget* table, const List<I>& data, P* functionParent, TableWidgetRowUpdateFunction updateRow)
	{
