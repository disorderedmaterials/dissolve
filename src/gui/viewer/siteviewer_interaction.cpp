/*
	...
	*** src/gui/viewer/siteviewer_interaction.cpp
...
void SiteViewer::startInteraction()
{
	switch (interactionMode())
	{
		...
		case (SiteViewer::DefaultInteraction):
			...
			if (buttonState_.testFlag(Qt::LeftButton)) setInteractionMode(SiteViewer::SelectAreaInteraction);
			else if (buttonState_.testFlag(Qt::RightButton)) setInteractionMode(SiteViewer::RotateViewInteraction);
			else if (buttonState_.testFlag(Qt::MiddleButton)) setInteractionMode(SiteViewer::TranslateViewInteraction);
			break;
		default:
			break;
	}
