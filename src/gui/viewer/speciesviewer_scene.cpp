/*
	...
	*** src/gui/viewer/speciesviewer_scene.cpp
...
void SpeciesViewer::drawScene()
{
	...
	{
		Messenger::error("Called SpeciesViewer::drawScene() with a NULL Species pointer.\n");
		return;
	}
...
// 		colour[3] = 0.5;
	...
	Vec3<double> vij;
	double mag;
	for (SpeciesBond* b = sourceSpecies_->bonds().first(); b != NULL; b = b->next)
	{
