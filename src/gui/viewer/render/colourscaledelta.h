/*
	*** Colour Scale Delta
	*** src/gui/viewer/render/colourscaledelta.h
...
#ifndef DISSOLVE_COLOURSCALEDELTA_H
#define DISSOLVE_COLOURSCALEDELTA_H
...
class ColourScaleDelta
{
	...
	void startColour(Vec4<GLfloat>& target) const;
	...
	void colour(double v, Vec4<GLfloat>& target) const;
