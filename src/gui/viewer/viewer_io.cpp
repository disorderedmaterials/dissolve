...
bool BaseViewer::writeAxisBlock(LineParser& parser, Axes& axes, int axis)
{
	...
	parser.writeLineF("      %s %f '%s' %f %f %f %f\n", BaseViewer::axisKeyword(BaseViewer::GridLineMajorStyleKeyword), style.width(), LineStipple::stipple[style.stipple()].name, style.colour().redF(), style.colour().greenF(), style.colour().blueF(), style.colour().alphaF());
	style = axes.gridLineMinorStyle(axis);
	parser.writeLineF("      %s %f '%s' %f %f %f %f\n", BaseViewer::axisKeyword(BaseViewer::GridLineMinorStyleKeyword), style.width(), LineStipple::stipple[style.stipple()].name, style.colour().redF(), style.colour().greenF(), style.colour().blueF(), style.colour().alphaF());
...
bool BaseViewer::writeViewBlock(LineParser& parser)
{
	...
	parser.writeLineF("    %s %i\n", BaseViewer::viewKeyword(BaseViewer::BoundingBoxKeyword), view_.boundingBox());
	parser.writeLineF("    %s %f\n", BaseViewer::viewKeyword(BaseViewer::BoundingBoxPlaneYKeyword), view_.boundingBoxPlaneY());
