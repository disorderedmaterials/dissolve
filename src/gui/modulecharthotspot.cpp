...
void ModuleChartHotSpot::set(int row, HotSpotType type, QRect geometry, FlowBlock* blockAfter)
{
	row_ = row;
	type_ = type;
	geometry_ = geometry;
	flowBlockAfterArea_ = blockAfter;
}
...
FlowBlock* ModuleChartHotSpot::flowBlockAfterArea() const
{
	return flowBlockAfterArea_;
}
