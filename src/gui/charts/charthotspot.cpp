...
void ChartHotSpot::setType(ChartHotSpot::HotSpotType type)
{
	type_ = type;
}

// Return the hotspot type
ChartHotSpot::HotSpotType ChartHotSpot::type() const
{
	return type_;
}
...
int ChartHotSpot::row() const
{
	return row_;
}

// Return column in which the hotspot exists
int ChartHotSpot::column() const
{
	return column_;
}

// Set area information
void ChartHotSpot::setGeometry(QRect geometry)
{
	geometry_ = geometry;
}
...
QRect ChartHotSpot::geometry() const
{
	return geometry_;
}

// Return if the supplied point exists within the hotspot
bool ChartHotSpot::contains(QPoint p) const
{
...
ChartBlock* ChartHotSpot::blockAfter() const
{
	return blockAfter_;
}
