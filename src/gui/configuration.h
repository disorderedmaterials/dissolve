...
class Configuration : public ListItem<Configuration>
{
	...
	// Atom array
	Atom* atoms_;
	// Flag indicating whether contents have changed since last RDF calculation
	...
	// Return whether Atom positions have changed since last RDF calculation
	bool contentsChanged();
	// Flag that contents have changed (owing to MC moves etc.)
	void setContentsChanged();
	// Reset contents changed flag
	void resetContentsChanged();
	///@}
