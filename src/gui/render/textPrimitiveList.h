...
class TextPrimitiveList
{
    ...
    void add(FontInstance *fontInstance, QString text, Vector3 anchorPoint, TextPrimitive::TextAnchor anchorPosition,
             Vector3 adjustmentVector, Matrix4 &rotation, double textSize, bool flat);
